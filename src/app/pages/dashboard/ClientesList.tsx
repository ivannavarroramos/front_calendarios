...
import { atisaStyles, getTableHeaderStyles, getTableCellStyles, getSecondaryButtonStyles } from '../../styles/atisaStyles'
import CustomToast from '../../components/ui/CustomToast'
import PageHeader from '../../components/ui/PageHeader'
import { Input, Select, Button, ListCard } from '../../../../atisa/AtisaComponents'
    ...
    >
      <div className="d-flex flex-column">
        <PageHeader
          ...
          subtitle="Administración de procesos y calendarios por cliente"
          icon="people"
          actions={
            <div className="d-flex align-items-center gap-3">
              <div className='position-relative'>
                ...
                <input
                  ...
                  placeholder='Buscar Razón Social o CIF...'
                  value={searchTerm}
              ...
              <div style={{ minWidth: '180px' }}>
                <select
                  ...
                  onChange={(e) => setFiltroCalendario(e.target.value as 'todos' | 'con' | 'sin')}
                  style={{
                    backgroundColor: 'rgba(255, 255, 255, 0.9)',
                    border: 'none',
                    borderRadius: '8px',
